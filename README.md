...
| React Zoom and pan | Zoom and pan 기능을 구현 하기 위해서는 엄청 길게 코드를 적어야 하고, state 를 통해서 props 로 비율 확대 축소등 정해줘야 하는게 많지만, zoom and pan 라이브러리를 사용하면 코드 2줄만 적게 되면 zoom and pan 기능을 사용할 수 있게 되어 편리해서 적용하게 되었습니다!|
