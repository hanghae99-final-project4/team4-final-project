...
<details>
<summary> 고객 반응 1- 1.이미지를 보내는데 발신자는 이미지 메시지를 받아오는데 이상하게 수신인은 이미지를 받아오지 못하는 이슈가 있었다.</summary>
<div markdown="1">
...
|개선 전 사진 |화면이 렌더링 됐을 때부터 안내가 분명하게 드러날 수 있게 했고 몇 공백과 언어에 상세한 안내도 추가했습니다.|
