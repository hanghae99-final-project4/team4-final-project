...
const Chatting = () => {
  ...
  const [chatArray, setChatArray] = useState([
    ...
    ['10년지기 이성친구 1명', '가끔 안부 묻는 이성친구 40명'],
    ['집에서 귀신보는 애인', '집에서 바퀴벌레 키우는 애인'],
    ['바람피고 자백 후 사죄하는 애인', '바람피고 숨기고 있는 애인'],
    ['팔만대장경 끝까지 읽기', '대장내시경 팔만 번 하기'],
    ['연어회 케찹 찍먹', '감자튀김 초장 찍먹'],
    ['10억 받고 폰 평생 안 쓰기', '10만원 받고 폰 평생 쓰기'],
    ['하루 5시간 치통', '하루 5시간 두통'],
    ['존잘 노잼', '존못 꿀잼'],
    ['닭이먼저', '계란이먼저'],
    ['절친 동생과 결혼', '절친과 내 동생 결혼'],
    ['강남역 앞에서 노홍철 저질댄스', '야구장 키스타임에 저질댄스'],
    ['다시 태어나면 키 155cm', '다시 태어나면 키 2m 30cm'],
    ['투명인간', '어떤 이성이든 홀리는 능력'],
    ['버거킹', '맘스터치'],
    ['이사하는 날 짜장면', '비 오는 날 파전'],
    ['피자', '치킨'],
    ['탄산 없는 콜라', '치즈 없는 피자'],
    ['비냉', '물냉'],
    ['계란 반숙', '계란 완숙'],
